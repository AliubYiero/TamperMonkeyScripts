...
export * from './getReadFavouriteList/getReadFavouriteList.ts';
...
export *
	from './sortOlderFavoritesToLast/sortOlderFavoritesToLast.ts';
export * from './autoAddVideoToFavourites/autoAddVideoToFavourites.ts';
