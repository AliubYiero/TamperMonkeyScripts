...
const questionList = [
  ...
  {
    question: "根据2021年11月的统计，以下各国CPI指数中，最大的是（）",
    answers: [
      "美国"
    ],
    isFAQ: false
  ...
  {
    question: "2021年以来,随着全球新冠肺炎疫情形势好转,世界经济复苏态势显著抬头,但仍面临很多困境。下列表述不正确的是（）",
    answers: [
      "发展中国家经济恢复明显好于发达国家"
    ],
    isFAQ: false
  ...
  {
    question: "党的十八大以来，习近平总书记高度重视（        ）在教育中的重要地位和作用，多次强调要坚持把（          ）作为根本任务，培养德智体美劳全面发展的社会主义建设者和接班人。",
    answers: [
      "立德树人"
    ],
    isFAQ: false
  ...
  {
    question: "我国目前高等教育办学规模和年毕业人数已居世界首位，但规模扩张不意味着质量和效益增长，走（        ）发展道路是我国高等教育发展的必由之路。",
    answers: [
      "内涵式"
    ],
    isFAQ: false
  ...
  {
    question: "我国办的是社会主义教育，就要坚持（       ）办学方向，坚持以人民为中心发展教育。",
    answers: [
      "社会主义"
    ],
    isFAQ: false
  ...
  {
    question: "不同于农业经济、工业经济以土地、劳动力和资本作为关键生产要素，数字经济的最鲜明的特点在于以（）作为关键生产要素。",
    answers: [
      "数据"
    ],
    isFAQ: false
  ...
  {
    question: "习近平总书记教育重要论述的内容体系中提到全面发展是指（      ）和“劳”，特别重视劳动教育的时代价值。",
    answers: [
      "德",
      "智",
      "体",
  ...
  },
  {
    question: "数字经济的内涵包括（）。",
    answers: [
      "以使用数字化的知识和信息作为关键生产要素",
      "以现代信息网络作为重要载体",
      "信息通信技术的有效使用",
      "推动效率提升和经济结构优化的一系列经济活动"
    ],
    isFAQ: false
  },
  {
    question: "十届全国人民代表大会第三次会议通过了《反分裂国家法》,这部法律的颁布具有重要意义,下面对《反分裂国家法》判断正确的是( ) A、   B、  C、   D、",
    answers: [
      "表明了全国人民捍卫国家主权和领土完整的共同意志和坚强决心",
      "是一部争取和平解决台湾问题、实现祖国和平统一的法律",
      "促进两岸直接“三通”,保护台湾同胞的正当权益,有利于维护台湾的和平与稳定",
      "把反对和遏制“台独”势力分裂活动的工作放在了比较突出的位置"
    ],
    isFAQ: false
  },
  {
    question: "提振世界经济的中国能力,源于中国着眼长远、协调全球健康发展的魄力,以下哪些是正确的?",
    answers: [
      "始终保持连续稳定的宏观政策,避免“大水漫灌”",
      "强化供需双向调节,组织多批次国家储备投放",
      "加强市场监管,遏制过度投机炒作",
      "做好预期管理,研究和适时出台部分惠企政策到期后的接续政策"
    ],
    isFAQ: false
  },
  {
    question: "2021年,全球经济复苏进程中出现多方面结构性失衡,主要表现为(    )",
    answers: [
      "供给恢复慢于需求恢复",
      "服务业恢复明显滞后于工业",
      "就业恢复慢于产出"
  ...
  {
    question: "各地区数字经济与国民经济发展水平没有正相关性。",
    answers: [
      "错误"
    ],
    isFAQ: false
  ...
  {
    question: "党的十九大报告中指出，中国特色社会主义已经进入新时代，社会的主要矛盾发生重大转变，转变为人民日益增长的美好生活需要与不平衡不充分的发展之间的矛盾。",
    answers: [
      "正确"
    ],
    isFAQ: false
  ...
  {
    question: "美国深度介入台海,是阻扰我们解决台湾问题、推进祖国统一的最大外部干扰。",
    answers: [
      "对"
    ],
    isFAQ: false
